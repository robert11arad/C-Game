...
int out(string value){
    ...
    if(value == "dead"){
        ...
        //return clearings(); // Only used in group version
        save(saveName, "|_F1N1SHED_|");
    }
    else if(value == "leaveR"){
        // Leaves cloudland 
        cout << "You leave cloudland and enter a shed" << endl;
        //return shed(); // Only used in group version
        save(saveName, "|_F1N1SHED_|");
    }
        ...
        //return dungeon(); // Only used in group version
        save(saveName, "|_F1N1SHED_|");
    }
    else if (value == "fight"){
...
/* This code is used in the group version
