...
void UpdateDatabase(string Process) //function used to update the database to keep track of the story progression
{
    try
        ...
        else if (Process == "NameUpdate") //if the parameter sent to the function was NameUpdate the name the player choose at the beginning gets saved to the 
            //Database
        {
...
void FetchData() //This function is used to load the data from the database on startup of the application.
{
